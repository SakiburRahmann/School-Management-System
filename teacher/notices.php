...
<style>
    ...
    .priority-Normal .priority-badge {
        background: #f0fff4;
        color: #2f855a; /* Green instead of blue for variety? Or keep blue/gray */
        background: #edf2f7;
        color: #718096;
    }
...
<div class="notices-hero">
    ...
    <p>Stay updated with the latest news, events, and important information from the administration.</p>
</div>
...
<?php if (empty($notices)): ?>
    <div class="empty-state">
        ...
        <p style="color: #718096;">It looks like there are no upcoming announcements at this time.</p>
    </div>
<?php else: ?>
        ...
        <?php foreach ($notices as $notice): ?>
            <div class="notice-card priority-<?php echo htmlspecialchars($notice['priority']); ?>">
                ...
                <div class="notice-footer">
                    ...
                    <!-- Could add 'Read More' if we had strict truncation, but full view is fine for now -->
                </div>
            </div>
        <?php endforeach; ?>
    </div>
